 ...
 */
Ext.define('invest.view.tenant.search.TenantSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.tenant.search',

    viewModel: {},
    controller: 'invest.tenant.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: invest.view.tenant.Tenant.servicePath + '/query',
                filterGroupId: invest.view.tenant.Tenant.moduleId,
