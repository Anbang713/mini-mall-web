 ...
 */
Ext.define('invest.view.tenant.edit.TenantEdit', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: ['invest.tenant.create', 'invest.tenant.edit'],

    controller: 'invest.tenant.edit',
    viewModel: {},

    createTitlebar: function () {
        return {
            xtype: 'typicalmoduletitlebar',
            router: 'invest.tenant',
            searchXtype: 'invest.tenant.combo',
            titleItems: [{
                xtype: 'bizstatelabel',
                captionMapping: {
                    using: '使用中',
                ...
                hidden: true,
                bind: {
                    text: '商户：{entity.name}[{entity.code}]',
                    hidden: '{!entity.uuid}'
                }
            }]
        };
    ...
    loadEntity: function () {
        var me = this;
        invest.view.tenant.TenantService.load(me.urlParams).then(function (entity) {
