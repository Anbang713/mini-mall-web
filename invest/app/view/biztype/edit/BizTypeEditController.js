 ...
 */
Ext.define('invest.view.biztype.edit.BizTypeEditController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.invest.biztype.edit',
    ...
    doSave: function () {
        ...
        invest.view.biztype.BizTypeService.save(entity);
    },
    ...
    doCancel: function () {
        ...
        Ext.Msg.confirm("提示", cancelMsg, function (success) {
            if (success == 'yes' && Cxt.util.Window.back() === false) {
                Cxt.util.Window.moduleRedirectTo(invest.view.biztype.BizType.moduleId, 'search', {localSearch: true});
