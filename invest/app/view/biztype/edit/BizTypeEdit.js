 ...
 */
Ext.define('invest.view.biztype.edit.BizTypeEdit', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: ['invest.biztype.create', 'invest.biztype.edit'],

    controller: 'invest.biztype.edit',
    viewModel: {},
    ...
    createTitlebar: function () {
        return {
            ...
            titleItems: [{
                ...
                hidden: true,
                bind: {
                    text: '业态：{entity.name}[{entity.code}]',
                    hidden: '{!entity.uuid}'
                }
            }]
        };
