 ...
 */
Ext.define('invest.view.position.view.PositionView', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.position.view',
    ...
    controller: 'invest.position.view',
    ...
    createTitlebar: function () {
        return {
            ...
            titleItems: [{
                ...
                xtype: 'label',
                cls: 'topTitle',
                bind: '铺位：{entity.name}[{entity.code}]'
            }],
            rightItems: [{
                xtype: 'authorbutton',
                text: '新建',
