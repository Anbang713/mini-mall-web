 ...
 */
Ext.define('invest.view.position.edit.PositionEditController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.invest.position.edit',
    ...
    doSave: function () {
        ...
        invest.view.position.PositionService.save(entity);
    },
    ...
    doCancel: function () {
        ...
        Ext.Msg.confirm("提示", cancelMsg, function (success) {
            if (success == 'yes' && Cxt.util.Window.back() === false) {
                Cxt.util.Window.moduleRedirectTo(invest.view.position.Position.moduleId, 'search', {localSearch: true});
