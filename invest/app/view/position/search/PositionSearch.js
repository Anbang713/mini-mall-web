 ...
 */
Ext.define('invest.view.position.search.PositionSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.position.search',

    viewModel: {},
    controller: 'invest.position.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: invest.view.position.Position.servicePath + '/query',
                filterGroupId: invest.view.position.Position.moduleId,
                fetchParts: ['store', 'building', 'floor'],
