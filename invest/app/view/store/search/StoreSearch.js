 ...
 */
Ext.define('invest.view.store.search.StoreSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.store.search',

    viewModel: {},
    controller: 'invest.store.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: invest.view.store.Store.servicePath + '/query',
                filterGroupId: invest.view.store.Store.moduleId,
