 ...
 */
Ext.define('invest.view.building.search.BuildingSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.building.search',

    viewModel: {},
    controller: 'invest.building.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: invest.view.building.Building.servicePath + '/query',
                filterGroupId: invest.view.building.Building.moduleId,
                fetchParts: ['store'],
