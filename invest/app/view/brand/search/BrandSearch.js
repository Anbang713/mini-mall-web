 ...
 */
Ext.define('invest.view.brand.search.BrandSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.brand.search',

    viewModel: {},
    controller: 'invest.brand.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: invest.view.brand.Brand.servicePath + '/query',
                filterGroupId: invest.view.brand.Brand.moduleId,
