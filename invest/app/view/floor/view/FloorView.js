 ...
 */
Ext.define('invest.view.floor.view.FloorView', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.floor.view',
    ...
    controller: 'invest.floor.view',

    createTitlebar: function () {
        return {
            xtype: 'typicalmoduletitlebar',
            router: 'invest.floor',
            searchXtype: 'invest.floor.combo',
            titleItems: [{
                xtype: 'bizstatelabel',
                captionMapping: {
                    'using': '使用中',
                ...
                xtype: 'label',
                cls: 'topTitle',
                bind: '楼层：{entity.name}[{entity.code}]'
            }],
            rightItems: [{
                xtype: 'authorbutton',
                text: '新建',
    ...
    loadEntity: function () {
        var me = this;
        invest.view.floor.FloorService.load(me.urlParams).then(function (entity) {
