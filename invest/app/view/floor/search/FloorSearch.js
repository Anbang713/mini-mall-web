 ...
 */
Ext.define('invest.view.floor.search.FloorSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'invest.floor.search',

    viewModel: {},
    controller: 'invest.floor.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: invest.view.floor.Floor.servicePath + '/query',
                filterGroupId: invest.view.floor.Floor.moduleId,
                fetchParts: ['store', 'building'],
