 ...
 */
Ext.define('product.view.goods.search.GoodsSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'product.goods.search',

    viewModel: {},
    controller: 'product.goods.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: product.view.goods.Goods.servicePath + '/query',
                filterGroupId: product.view.goods.Goods.moduleId,
