 ...
 */
Ext.define('account.view.subject.search.SubjectSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'account.subject.search',

    viewModel: {},
    controller: 'account.subject.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: account.view.subject.Subject.servicePath + '/query',
                filterGroupId: account.view.subject.Subject.moduleId,
