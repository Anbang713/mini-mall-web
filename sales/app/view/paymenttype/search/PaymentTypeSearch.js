 ...
 */
Ext.define('sales.view.paymenttype.search.PaymentTypeSearch', {
    extend: 'Cpnt.frame.BaseContentPanel',
    xtype: 'sales.paymenttype.search',

    viewModel: {},
    controller: 'sales.paymenttype.search',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            items: [{
                ...
                itemId: 'searchGrid',
                width: '100%',
                queryUrl: sales.view.paymenttype.PaymentType.servicePath + '/query',
                filterGroupId: sales.view.paymenttype.PaymentType.moduleId,
